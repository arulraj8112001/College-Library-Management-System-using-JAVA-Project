...
<body>
    ...
    <div class="fixed-buttons">
        <button class="btn" onclick="window.location.href='allstaff.jsp'">
...
-->
    ...
    <div class="container">
        ...
        <%
            ...
            ps = con.prepareStatement("SELECT UCOLUMNS FROM STAFFDETAILS WHERE UCOLUMNS != 'empty' and UCOLUMNS !='stafftype' ");
            rs = ps.executeQuery();
        %>
